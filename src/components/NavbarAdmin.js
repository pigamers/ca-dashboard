    ...
    <div>
      ...
      <div
        className={`${close ? "hidden " : "block "
          } fixed top-0 bottom-0 lg:top-5 lg:bottom-5 left-0 p-2 w-[350px] z-50 md:w-[300px] text-center bg-[#3C37FF]`}
      >
        ...
        <div>
          <a href="/home-admin">
            <div
              className="p-2.5 flex mt-3 items-center rounded-md px-4 text-white duration-300 cursor-pointer hover:bg-blue-300 text-center"
            >
